        ...
        Shimmer(
          child: Column(
            children: List.generate(3, (index) {
              final randomWidth = 0.3 + math.Random().nextDouble() * 0.5;
              return ListTile(
                title: Container(
                  height: 20,
...
class _HoverButton extends StatefulWidget {
  const _HoverButton({required this.isFavorite, required this.onTap});
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: widget.isFavorite
                ? (isHovered ? Colors.red.shade700 : Colors.red)
                : (isHovered ? Colors.green.shade700 : Colors.green),
            borderRadius: BorderRadius.circular(12),
          ),
          child: Text(
            widget.isFavorite ? "Remove".tl : "Add".tl,
            style: ts.s12.copyWith(color: Colors.white),
          ),
        ),
      ),
    );
